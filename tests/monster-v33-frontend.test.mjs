...
assert.match(manifest.start_url,/war-room-monster-v58-20260905/);
...
const maikUiStubs={
  ...
  maikValueInlineMarkup:()=>"FBA-Value –",maikValuePlayerColor:()=>"rgb(135,147,167)",
...
assert.match(html,/war-room-monster-v58-20260905/,"Vorbereiteter Build muss v57 ausweisen");
