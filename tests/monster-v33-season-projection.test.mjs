...
assert.ok(start>=0&&end>start,"Der reine v40-Saisonprognose-Rechner muss vorhanden sein");
...
console.log("PASS · Matchup Monster v40 season projection frontend tests");
